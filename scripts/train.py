...
conf = configure_dataset(
    ...
    num_classes=4,
    remap_mscoco=False,
    output_dir="./nbs/outputs/rock-paper-scissors/deim_hgnetv2_s_dfine_obj365_s_10ep",
)

trainer = Trainer(conf)

trainer.load_checkpoint("/home/dnth/Desktop/DEIMKit/checkpoints/dfine_s_obj365.pth")
